...
function IncidentServiceChart({ data }) {
  return (
    <div className="chart-card">
      <h2>Incidents par service</h2>

      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={data}>
          <CartesianGrid stroke="#dbe3ea" vertical={false} />
          <XAxis dataKey="service" tick={{ fontSize: 12, fill: "#8698a8" }} axisLine={{ stroke: "#dbe3ea" }} tickLine={false} />
...
export default IncidentServiceChart;